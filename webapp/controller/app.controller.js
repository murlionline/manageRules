sap.ui.define([
	...
	return Controller.extend("sap.demo_rulesmanagertemplate.controller.app", {
		...
		loadDecisionTable: function() {
			...
			projectId = this.getOwnerComponent().oComponentData.startupParameters.ruleProjectID;
			ruleId = this.getOwnerComponent().oComponentData.startupParameters.ruleID;
			ruleVersion = this.getOwnerComponent().oComponentData.startupParameters.ruleVersion;
			//ruleServiceID = this.getOwnerComponent().oComponentData.startupParameters.ruleService;
		...
		onDeployPress: function() {
			...
			var ruleServiceID = this.getOwnerComponent().oComponentData.startupParameters.ruleService;
